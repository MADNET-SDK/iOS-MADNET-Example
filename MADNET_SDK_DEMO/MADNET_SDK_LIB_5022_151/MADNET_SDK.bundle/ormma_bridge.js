...
(function()
 {
    ...
    var orientationProperties = {
     ...
     ormmaview.fireErrorEvent = function(message, action)
     {
         ...
         this.executeNativeCall("errorhandler", "message", message, "action", action);
         return "OK";
	 };

     ormmaview.onError = function(message, action)
     {
         this.executeNativeCall("errorhandler", "message", message, "action", action);
	 }
 ...
 ormmaview.setOrientationProperties = function(properties)
 {
    ...
    expandProperties.lockOrientation = !properties.allowOrientationChange;
    this.executeNativeCall("orientationproperties",
                        "allowOrientationChange", properties.allowOrientationChange,
     ...
     ormmaview.setExpandProperties = function(properties)
     {
         ...
         orientationProperties.allowOrientationChange = !properties.lockOrientation;
	 };
     ...
     ormmaview.createCalendarEvent = function(start, end, description, summary, location)
     {
         this.executeNativeCall("createEvent",
                                "start", start,
                                "end", end,
     ...
     ormmaview.useCustomClose = function(flag)
     {
         ...
         this.executeNativeCall("usecustomclose", "flag", flag);
	 };
